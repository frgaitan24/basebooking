...
<body>
	...
	<div class="loginbox">
		...
		<form action="signup.php" method="post" class="animated flipInY">
			<p style="font-size:16px">Nombre de usuario:</p>
			<input type="text" name="username" placeholder="Ingrese su usuario" required>
			
			<p style="font-size:16px">Correo:</p>
			<input type="email" name="email" placeholder="Enter su correo" required>
			
			<p style="font-size:16px">Contraseña:</p> <input type="password" name="password" placeholder="Ingrese su contraseña" id="myInput" required>
			<table height="10px" width="200px" style="margin-bottom:10px;padding: 0px;"><tr>
			<td> <p style="font-size:12px; padding-top=0px;">Mostrar Contraseña</p> </td>
			<td width='15' style='padding-top:15px; padding-right:90px;'><center><input type="checkbox"  onclick="myFunction()"></center></td></tr></table>
			
			

			<p style="font-size:16px">Confirmar contraseña:</p><input type="password" name="password1" placeholder="Confirme su contraseña" id="myInput1" required>
